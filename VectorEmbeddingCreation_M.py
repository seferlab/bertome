...
print(len(x_tokens_tensor[0]))

x_segments_tensors = torch.tensor([x_segment_ids])
print(len(x_segments_tensors[0]))
...
directory_x = r"C:\Users\nisas\PycharmProjects\RNA-DNA-Nisa\MEMBEDDINGSX.npy"
np.save(directory_x, x)

directory_y = r"C:\Users\nisas\PycharmProjects\RNA-DNA-Nisa\MEMBEDDINGSY.npy"
