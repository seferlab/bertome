...
# One-hot encoding for given sequences
...
plt.clf()
plt.plot([0, 1], [0, 1], "k--")
plt.plot(fpr_keras_dt, tpr_keras_dt, label="Keras (area = {:.3f})".format(auc_keras_dt))
...
plt.clf()
plt.plot([0, 1], [0, 1], "k--")
plt.plot(fpr_keras_rf, tpr_keras_rf, label="Keras (area = {:.3f})".format(auc_keras_rf))
plt.xlabel("False positive rate", fontsize = 15)
plt.ylabel("True positive rate", fontsize = 15)
...
plt.clf()
plt.plot([0, 1], [0, 1], 'k--')
plt.plot(fpr_keras_xgb, tpr_keras_xgb, label='Keras (area = {:.3f})'.format(auc_keras_xgb))
plt.xlabel("False positive rate", fontsize = 15)
plt.ylabel("True positive rate", fontsize = 15)
...
plt.clf()
plt.plot([0, 1], [0, 1], 'k--')
plt.plot(fpr_keras_svm, tpr_keras_svm, label='Keras (area = {:.3f})'.format(auc_keras_svm))
plt.xlabel("False positive rate", fontsize = 15)
plt.ylabel("True positive rate", fontsize = 15)
