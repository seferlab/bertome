...
#rmbase_dataset = pd.read_excel("RMBase_Big_To_Short.xlsx")
rmbase_dataset = pd.read_excel("RMBase_800.xlsx")

y = rmbase_dataset.label
x = rmbase_dataset.drop(["label"], axis = 1)
